import 'package:driving/lanking_page.dart';
import 'package:driving/userpage.dart';
          ...
          children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: currentTap==0 ?  Color(0xffC5DFE4) : Colors.transparent,
                    ),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
            ...
            MaterialButton(
              ...
              onPressed: (){
                setState((){
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context)=>lanking_page())
                  );
                });
              },
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: currentTap==1 ?  Color(0xffC5DFE4) : Colors.transparent,
                    ),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
            ...
            MaterialButton(
              ...
              child: Container(
                ...
                height: 50,
                decoration: BoxDecoration(
                  color: currentTap==2?  Color(0xffC5DFE4) : Colors.transparent,
                  shape: BoxShape.circle,
                ),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
