...
import 'package:driving/driving_page.dart';
...
class main_page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          leading: Icon(Icons.menu,color: Colors.black,size: MediaQuery.of(context).size.height/20,),
          elevation: 0,
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          Image.asset("assets/tofu_75.png",scale: 2,),
                          Text("76점",style: TextStyle(fontSize: 15),),
                          Text("현재 랭킹 1407위",style: TextStyle(fontSize: 20),)
                        ],
                      ),
                    ),
                  ),
                  ...
                  child: Container(
                    ...
                    child: Align(
                        ...
                        child: Container(
                          ...
                          child: Text("이번주 주요 실수",style: TextStyle(fontWeight: FontWeight.w700),),
                        )
                    ),
                  ),
                ),
